        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FinalPrice = table.Column<decimal>(type: "decimal(6,2)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Adha-Aid discount", 10 },
                    { 2, "Christmas discount", 20 },
                    { 3, "Labor day discount", 30 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Student discount", 20 },
                    { 2, "Engineer discount", 40 },
                    { 3, "Patient discount", 50 }
                });

            migrationBuilder.InsertData(
                table: "RoutePrices",
                columns: new[] { "Id", "BusTypeId", "DurationHours", "EndCityId", "Price", "StartCityId" },
                values: new object[,]
                {
                    { 1, 1, 5, 2, 1200m, 1 },
                    { 2, 1, 5, 1, 1200m, 2 },
